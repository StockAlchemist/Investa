    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <div className="flex flex-col">
                        <div className="flex items-center gap-3">
                            ...
                            <button
                                ...
                                className="flex items-center gap-1.5 text-[11px] font-semibold text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 transition-colors uppercase tracking-[0.06em] mt-0.5 cursor-pointer"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {topics.map(t => (
                    <div key={t.id} className={cn(
                        ...
                        <span className="text-[11px] font-semibold text-muted-foreground uppercase tracking-[0.06em]">{t.id}</span>
                ...
                <div className={cn(
                    ...
                    {typeof analysis.sentiment === 'number' ? (
                        <div className="flex flex-col items-center py-4">
                            ...
                            <div className="flex justify-between w-full text-[11px] font-semibold text-muted-foreground uppercase tracking-[0.06em] px-1">
                                ...
                                <div key={i} className="flex gap-4 group">
                                    ...
                                    <div className="flex-1 pb-4">
                                        <div className="flex items-center justify-between mb-1">
                                            ...
                                            <Badge variant="outline" className="text-[11px] font-semibold uppercase border-muted-foreground/20 text-muted-foreground tracking-[0.06em]">
                                                {c.impact}
                                            </Badge>
                                        </div>
            ...
            <div className="text-center pb-8">
                <p className="text-[11px] text-muted-foreground uppercase tracking-[0.06em] font-medium opacity-50">
