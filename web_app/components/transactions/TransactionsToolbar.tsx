            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3.5 py-2 bg-primary hover:bg-primary-hover text-primary-foreground rounded-control text-[13px] font-semibold transition-colors cursor-pointer"
                    >
                    ...
                    <div className="relative inline-block text-left" ref={importMenuRef}>
                        ...
                        {isImportMenuOpen && (
                            ...
                            >
                                <div className="px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.06em] text-muted-foreground/80">
                                    Import to account
                                </div>
                                ...
                                <button
                                    ...
                                    className="flex items-center justify-center gap-2 w-full px-2.5 py-2 text-xs font-semibold rounded-control bg-primary hover:bg-primary-hover text-primary-foreground transition-colors cursor-pointer"
                                >
            ...
            <div className="bg-card/40 border border-border/60 rounded-2xl p-4 flex flex-col gap-3">
                ...
                {availableTypes.length > 0 && (
                    <div className="flex flex-wrap items-center gap-1.5 pt-1 border-t border-border/30">
                        <span className="text-[11px] uppercase font-semibold tracking-[0.06em] text-muted-foreground/60 mr-1">Type:</span>
