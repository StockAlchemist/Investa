...
def patched_tool(monkeypatch):
        ...
        [
            {
                ...
                "Account": "IBKR",
                "Quantity": 1314.0,
                "Market Value (USD)": 482842.43,
                "Total Gain (USD)": 284036.0,
                "Total Return %": 142.54,
            },
            # A Thai fund: large native (THB) NAV, but small once converted to USD.
            {
                ...
                "Account": "SET",
                "Quantity": 88177.0,
                "Market Value (USD)": 60715.93,
                "Total Gain (USD)": 5000.0,
                "Total Return %": 9.0,
            },
            # Aggregate row must be excluded.
            {
                ...
                "Account": "",
                "Quantity": np.nan,
                "Market Value (USD)": 999999.0,
                "Total Gain (USD)": np.nan,
                "Total Return %": np.nan,
            },
    ...
    overall = {
        "market_value": 1838470.51,
        "total_gain": 1791398.92,
        "total_return_pct": 40.82,
        "cash_balance": 19151.39,
    }
