...
def _run_holdings(txns, symbol_to_id, type_to_id):
    ...
    qty, cost, *_ = _calculate_holdings_numba(
        ...
        1,
        type_to_id["split"],
        type_to_id["stock split"],
        type_to_id["buy"],
        type_to_id["deposit"],
        type_to_id["sell"],
        type_to_id["withdrawal"],
        type_to_id["short sell"],
        type_to_id["buy to cover"],
        type_to_id["transfer"],
        type_to_id["spin off"],
        type_to_id["fees"],
        type_to_id["dividend"],
...
def _spinoff_holdings():
    ...
    rows = [
        # Original SPGI position: 105 sh, total basis 50,466.21.
        {
            ...
            "Symbol": "SPGI",
            "Quantity": 105.0,
            "Price/Share": 50466.21 / 105.0,
            "Total Amount": 50466.21,
            "Date": "2025-01-02",
        },
        # Spin-off child receipt: 105 MBGL at allocated basis 2,451.80.
        {
            ...
            "Symbol": "MBGL",
            "Quantity": 105.0,
            "Price/Share": 2451.80 / 105.0,
            "Total Amount": 2451.80,
            "Date": "2026-06-30",
        },
    ...
    holdings, *_ = _process_transactions_to_holdings(
        ...
        historical_fx_lookup={},
        display_currency_for_hist_fx="USD",
