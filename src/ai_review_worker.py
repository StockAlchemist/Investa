...
def check_if_review_exists(
    symbol: str, fund_data: Optional[dict] = None, universe: str = "sp500"
) -> bool:
    """
...
def save_review_to_screener(
    symbol: str, review: dict, fund_data: dict, universe: str = "sp500"
):
    """
...
def process_stock(
    symbol: str, mdp, fund_data: dict, universe: str = "sp500"
) -> Union[bool, str]:
    """
