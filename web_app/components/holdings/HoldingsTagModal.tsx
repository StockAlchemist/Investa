            ...
            <div className="bg-card rounded-lg shadow-none w-full max-w-sm p-4 space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="w-full px-3 py-2 bg-secondary border-none rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                        autoFocus
                    />
                ...
                <div className="flex justify-end gap-2">
                    ...
                    <button
                        ...
                        disabled={isPending}
                        className="px-3 py-1.5 text-sm bg-primary text-primary-foreground rounded hover:bg-[#0086a0] transition-colors flex items-center gap-2 disabled:opacity-50"
                    >
